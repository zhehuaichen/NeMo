...
from nemo.collections.multimodal.parts.utils.data_utils import get_num_samples_from_files, to_cuda
...
class ModularizedAudioGPTModel(MegatronGPTLoRAModel):
    ...
    def prepare_llm_input(self, audio_batch: Dict):
    ...
    def _modify_config(cls, gpt_cfg, cfg, audio_cfg, add_cfg_to_tree=False):
        ...
        with open_dict(gpt_cfg):
            ...
            gpt_cfg.freeze_modality_adapter = cfg.model.freeze_modality_adapter
