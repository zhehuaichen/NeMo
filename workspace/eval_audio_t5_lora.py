...
from nemo.collections.multimodal.models.speechllm_t5_models import ModularizedAudioT5Model
...
@hydra_runner(config_path="../examples/multimodel/conf/speechllm", config_name="modularized_speech_t5_config_eval")
def main(cfg) -> None:
    ...
    model = ModularizedAudioT5Model.restore_from(
